"""Generate masked/unmasked trajectory features and plots for router training.

Outputs:
- data/trajectories_dataset.csv
- plots/prompt_* diagnostic figures
"""
...
def main():
    ...
    df.to_csv("data/trajectories_dataset.csv", index=False)
    print("Saved 'data/trajectories_dataset.csv'.")
