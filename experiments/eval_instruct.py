...
configs = [
    ...
    (
        "8. CoVe (2 checks)",
        lambda q: cove_generate(q, max_new_tokens=80)
    ),
    (
        "9. GADR-2 Learned Router",
        lambda q: gadr2_generate(q, max_new_tokens=80)
    ),
]
...
if __name__ == "__main__":
    ...
    for label, fn in configs:
        ...
        out_path = ROOT / "results" / "instruct_results.json"
    ...
    print("Results saved to results/instruct_results.json", flush=True)
