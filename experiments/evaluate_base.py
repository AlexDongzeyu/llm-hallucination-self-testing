"""
evaluate.py -- Step 5 (revised): Open-ended generation evaluation.
...
from generate import gated_generate
...
if __name__ == "__main__":
    ...
    # Save
    with open("bon_results.json", "w") as f:
        json.dump(all_results, f, indent=2)
    print("\nSaved to bon_results.json")
